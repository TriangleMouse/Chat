...
namespace ChatServer
{
    ...
    public class StatusChangedEventArgs : EventArgs
    {
        ...
        // Свойство для получения и установки сообщения о событии
    ...
    class ChatServer
    {
        ...
        public static Hashtable htUsers = new Hashtable(30); // 30 пользователей за один лимит времени
        // В этой хэш-таблице хранятся соединения и пользователи (просматриваемые по соединению)
        public static Hashtable htConnections = new Hashtable(30); // 30 пользователей за один лимит времени
